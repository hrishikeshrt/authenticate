...
// call main function after IP has been set
function main() {
  IP = GM_getValue("MyIP");
  ...
  httpsAuthURL1 = 'https://ironport1.iitk.ac.in/B0001D0000N0000N0000F0000S0000R0004/'+ IP + '/https://www.google.co.in/';
  httpsAuthURL2 = 'https://ironport2.iitk.ac.in/B0001D0000N0000N0000F0000S0000R0004/'+ IP + '/https://www.google.co.in/';

  refreshDuration = (5 * 60000);  // refresh in ms  = ( refreshMin * 60 * 1000 )
  ...
  if (document.body.innerHTML.match("You are logged in")) {
    ...
    //  Google("http://www.google.co.in","Google");
  }
}
...
function getIP(l) {
  GM_xmlhttpRequest({
    ...
    onload: function(responseDetails) {
      ...
      // alert(getip.responseText);
      var ip = FindText(result,"<ip>","</ip>");
      GM_setValue("MyIP",ip);
      main();
    },
    onerror: function(responseDetails) {
      var details_box = document.getElementById('details');
      details_box.innerHTML += "<br><br><b>Fetching IP</b> (" + w + ") : ";
